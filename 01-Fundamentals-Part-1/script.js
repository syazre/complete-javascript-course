...
const BMISyafiq = massSyafiq / heightSyafiq ** 2;
const BMIShikin = massShikin / (heightShikin * heightShikin);
console.log(BMISyafiq, BMIShikin);
if (BMISyafiq > BMIShikin) {
  console.log(`Syafiq's BMI (${BMISyafiq}) is higher than Shikin's (${BMIShikin})!`)
} else {
  console.log(`Shikin's BMI (${BMIShikin}) is higher than Syafiq's (${BMISyafiq})!`)
}
 */
////////////////////////////////////
...
if (aveDolphins > aveKoalas && aveDolphins >= 100) {
  ...
  console.log('Dolphins and Koalas win draw.');
} else {
